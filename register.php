...
<div class="footer">
	<div class="container">
		...
		<div class="clearfix"></div>
		<p class="copy-right">© 2019 Fashion Club . All rights reserved | Design by Vincent Team</p>
	</div>
</div>
	<!-- cart-js -->
...
// check connection 
                       ...
                       $sql = " INSERT INTO user ( username,Email,Passward) VALUES 
                       ( '$username', '$Email', '$Password');";
                        if ( $Password== $Confirm_Password){
                         ...
                         echo "<script > location.href='login.php'</script>";
                        	...
                        	echo "<script> alert ('You should confirm your password ');
